...
public class PlayerAmountManager : MonoBehaviour
{
    ...
    public Vector2Int[] Inventory = new Vector2Int[3]; // x : số đạn hiện tại, y : số băng đạn hiện tại
    GunStatic currentWeapon;
    Coroutine reloadCoroutin;
    InputAction reloadAction;
    public int currBullets, currMags;
    ...
    private void Update()
    {
        ...
        currBullets = Inventory[(int)currentWeapon].x;
        currMags = Inventory[(int)currentWeapon].y;
    }
